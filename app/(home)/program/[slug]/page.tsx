      ...
      <div className="flex flex-col gap-20">
        ...
        <div className="flex w-full justify-between align-middle">
          <div className="flex flex-col gap-3">
            ...
            <span className="text-neutral-400 text-sm font-normal">
              An overview of the fitness plan and current health
            </span>
          </div>

          <Link href="/chat">
            <Button className="rounded-full px-8 py-4 text-md">Ask AI Assistant</Button>
          </Link>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center w-full h-full justify-between gap-10">
          ...
          <div className="flex flex-col gap-5 w-full h-full">
            <h3 className="text-xl font-semibold">Weight Estimation</h3>
            <div>
            ...
            <Card className="bg-neutral-50 text-sm text-neutral-600 pt-2">
              <CardContent className="flex flex-col gap-2">
                ...
                <p className="flex flex-wrap gap-1">
                  ...
                  with the same BMI can have different health profiles.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="flex flex-col gap-5 w-full h-full">
            ...
            <Card className="bg-neutral-50 text-sm text-neutral-600 pt-3">
              <CardContent className="flex flex-col gap-2">
                ...
                <p>
                  The health score of your body's structure has been calculated
                  by taking into account your gender and age. This personalized
          ...
          <div className="flex flex-col gap-5 w-full h-full">
            ...
            {ideal_weight === data.overview.weight &&
              data.overview.fitness_goal !== "build_muscle" && (
                <p>
                  Based on the D.R. Miller formula, your current weight is
            ...
            {ideal_weight !== data.overview.weight &&
              data.overview.fitness_goal !== "build_muscle" && (
                <p>
                  Based on the D.R. Miller formula and your fitness goal, the
          ...
          <div className="flex flex-col gap-5 w-full h-full">
            ...
            {composition.ideal_fat >= composition.fat_percentage ? (
              <p>
                ...
                so our goal is to ensure that you maintain this body structure.
              </p>
            ) : (
              <p>
          ...
          <div className="flex flex-col gap-5 w-full h-full">
            ...
            <div className="flex flex-col gap-1">
              ...
              <ul className="list-disc list-inside">
                ...
                <li>Bread (e.g., whole grain bread, baguette)</li>
                <li>Potatoes</li>
                <li>Quinoa</li>
                <li>Oats</li>
