      ...
      <div className="flex flex-col justify-between align-middle">
        ...
        <div className="flex flex-col space-y-2">
          <Label htmlFor="age" className="text-md lg:text-lg">
            How many days a week are you willing to dedicate to fitness?
          </Label>
          <Picker
            max={7}
            min={2}
            ...
            onRemove={() => {
              setAnswers({
                ...answers,
                workout_days: answers.workout_days - 1,
              });
            }}
        ...
        {/* active */}
        <div className="flex flex-col w-full space-y-1.5 mb-20">
          ...
          >
            ...
            <div className="w-full h-full col-span-1">
              ...
              >
                ...
                Some movement
                <span className="text-neutral-400 text-sm text-center font-normal">
                  I occasionally do physical exercises
                </span>
              </Label>
            </div>
            ...
            <div className="w-full h-full col-span-1">
              ...
              >
                ...
                Moderately Active
                <span className="text-neutral-400 text-sm text-center font-normal">
                  I spend an average of 60 minutes a day doing physical
                  activities
                </span>
              </Label>
            </div>
