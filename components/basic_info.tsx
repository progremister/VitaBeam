        ...
        {is_choose && is_accurate && (
          <div className="flex flex-col w-full gap-3">
            ...
            <p className="text-neutral-400 text-sm mb-3">
              To accurately determine body fat percentage, we need two measurements: neck size and waist size.
              These essential measurements enable us to calculate your body fat percentage.
            </p>
